...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="dark flex h-screen flex-col items-center bg-background text-white">
          ...
          {postQuery.data ? (
            <div className="w-full max-w-2xl">
              {postQuery.data?.length === 0 ? (
                ...
                <div className="flex h-[30vh] justify-center overflow-y-scroll px-4 text-2xl">
